...
@Component({
  selector: 'app-exercice-idee',
  templateUrl: './exercice-idee.component.html',
  styleUrls: ['./exercice-idee.component.css']
})
export class ExerciceIdeeComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.form = this.formBuilder.group({
      ...
      exercice_position: ['', Validators.required],
